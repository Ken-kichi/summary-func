...
# requirements.txtを生成
~/Desktop/news-summarizer $ uv pip compile ./pyproject.toml > ./requirements.txt

# 依存パッケージをインストール
~/Desktop/news-summarizer $ uv add -r ./requirements.txt
```
...
$(function () {
    ...
    const resetButtons = () => {
        ...
        $downloadDiagramBtn.prop('disabled', false);
    };
